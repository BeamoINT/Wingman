...
function transformApplication(data: Record<string, unknown>): CompanionApplication {
  return {
    ...
    companionAgreementVersion: (data.companion_agreement_version as string) || null,
    companionAgreementAcknowledgedAt: (data.companion_agreement_acknowledged_at as string) || null,
    onboardingLastStep: typeof data.onboarding_last_step === 'number' ? data.onboarding_last_step : null,
    profileSetupCompletedAt: (data.profile_setup_completed_at as string) || null,
    idVerificationFailureCode: (data.id_verification_failure_code as string) || null,
    idVerificationFailureMessage: (data.id_verification_failure_message as string) || null,
