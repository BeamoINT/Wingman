...
function transformSupabaseUser(supabaseUser: SupabaseUser, profile?: any): User {
  ...
  return {
    ...
    profilePhotoSource: profile?.profile_photo_source || 'unknown',
    profilePhotoCapturedAt: profile?.profile_photo_captured_at || null,
    profilePhotoCaptureVerified: profile?.profile_photo_capture_verified === true,
    profilePhotoLastChangedAt: profile?.profile_photo_last_changed_at || null,
